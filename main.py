...
def main():
    ...
    if do_synchronization:
        ...
        sync_android_out_path = ("C:/Users/srale/OneDrive - FCT "
                                 "NOVA/Tese/subjects/P002/acc_gyr_mag_phone/sync_android_P002")
        output_path = "C:/Users/srale/OneDrive - FCT NOVA/Tese/subjects/P002/acc_gyr_mag_phone/synchronized_P002"
        selected_sensors = {'phone': ['acc', 'gyr', 'mag']}
        sync_type = 'crosscorr'
        evaluation_path = "C:/Users/srale/OneDrive - FCT NOVA/Tese/subjects/P002/acc_gyr_mag_phone/sync_evaluation_P002"
        synchronization(raw_data_in_path, sync_android_out_path, selected_sensors, output_path, sync_type,
                        evaluation_path)

    if do_processing:
        output_path = "C:/Users/srale/OneDrive - FCT NOVA/Tese/subjects/P002/acc_gyr_mag_phone"
        filtered_folder_name = "filtered_tasks_P002"
        raw_folder_name = "raw_tasks_P002"
        sync_data_path = "C:/Users/srale/OneDrive - FCT NOVA/Tese/subjects/P002/acc_gyr_mag_phone/sync_android_P002"
    ...
    if do_feature_extraction:
        ...
        main_path = "C:/Users/srale/OneDrive - FCT NOVA/Tese/subjects/P002/acc_gyr_mag_phone/filtered_tasks_P002"
        output_path = "C:/Users/srale/OneDrive - FCT NOVA/Tese/subjects/P002/acc_gyr_mag_phone"
        feature_extractor(main_path, output_path, subclasses)

    if do_one_subject_feature_selection:
        dataset_path = ("C:/Users/srale/OneDrive - FCT NOVA/Tese/subjects/P002/acc_gyr_mag_phone/features_basic_activities"
                        "/acc_gyr_mag_phone_features_P002.csv")
        output_path_plots = "C:/Users/srale/OneDrive - FCT NOVA/Tese/subjects/P002/acc_gyr_mag_phone"
    ...
    if do_all_subjects_feature_selection:
        ...
        subjects_dict = get_all_subjects_best_features(subject_path, features_folder_name, nr_iterations,
                                                       clustering_model)
        all_subjects_most_common_features = get_top_features_across_all_subjects(subjects_dict, 15)
...
#     train_set = _drop_low_variance_features(train_set, variance_threshold=0.05)
...
#                         print(f"Feature frequency in best feature sets: {find_most_common_features_in_best_sets(best_feature_sets)}")
#
#                     else:
...
#
#
# def find_most_common_features_in_best_sets(best_feature_sets, n=4):
...
#
#
# # Step 1: Get the Best Feature Sets and Accuracies for Each Subject
# subjects_dict = get_all_subjects_best_features(main_path, "features_basic_activities", nr_iterations, clustering_model, output_path_plots)
#
# # Step 2 and 3: Aggregate the most common features across all subjects
# all_most_common_features = aggregate_most_common_features(subjects_dict)
# print("All Most Common Features Across Subjects:", all_most_common_features)
#
# # Step 4: Count Feature Frequency
# feature_counter = count_feature_frequency(all_most_common_features)
