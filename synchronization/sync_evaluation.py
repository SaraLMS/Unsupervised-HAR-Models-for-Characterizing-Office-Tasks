...
from synchronization.sync_devices_timestamps import get_tau_filename, get_tau_logger
...
def sync_evaluation(logger_folder_path: str, sync_folder_path: str) -> pd.DataFrame:
    """
